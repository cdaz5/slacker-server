  ...
  Mutation: {
    getOrCreateChannel: _permissions2.default.createResolver(function () {
      var _ref = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee2(parent, _ref2, _ref3) {
        ...
        var member, allMemebers, _ref4, _ref5, data, result, users, name, channelData;
        ...
        return _regenerator2.default.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 5:
                allMemebers = [].concat((0, _toConsumableArray3.default)(members), [user.id]);
                _context2.next = 8;
                      ...
                      while (1) {
                        switch (_context.prev = _context.next) {
                          ...
                          case 2:
                            ...
                            pcmembers = allMemebers.map(function (m) {
                          ...
                          case 7:
                            return _context.abrupt('return', channel.dataValues);
          ...
          while (1) {
            switch (_context4.prev = _context4.next) {
              ...
              case 12:
                ...
                return _context4.abrupt('return', {
                  ok: false,
                  errors: (0, _FormatErrors.formatError)(_context4.t0, models)
                });
