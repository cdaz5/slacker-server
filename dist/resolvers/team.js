...
exports.default = {
  Query: {
    getTeamMembers: _permissions2.default.createResolver(async (parent, { teamId }, { models }) => models.sequelize.query('select * from users as u join members as m on m.user_id = u.id where m.team_id = ?', {
      replacements: [teamId],
      model: models.User,
      raw: true
    }))
  ...
  Mutation: {
    addTeamMember: _permissions2.default.createResolver(async (parent, { email, teamId }, { models, user }) => {
      try {
    ...
    createTeam: _permissions2.default.createResolver(async (parent, args, { models, user }) => {
      try {
